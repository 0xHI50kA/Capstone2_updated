...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
        $sql = "INSERT INTO nurse_profiles (name, image_path, map_embed) VALUES (:name, :image, :embed)";
...
<div id="confirmModal">
    <div class="modal-content">
        ...
        <p>Are you sure you want to save this profile?</p>
