...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
        $sql = "INSERT INTO medical_clinics (name, image_path, map_embed) VALUES (:name, :image, :embed)";
        ...
        if ($stmt->execute()) {
            echo "<script>setTimeout(() => { window.location.href = 'crudLocator1.php'; }, 0);</script>";
        } else {
            $errorMessage = "Failed to save clinic.";
        }
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>Add Medical Clinic</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <form id="clinicForm" method="POST" enctype="multipart/form-data">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <a href="crudLocator1.php" style="text-decoration:none; background:#6c757d; color:white; padding:12px 20px; border-radius:6px;">Back</a>
            </div>
        </form>
    </div>
</div>
...
<div id="confirmModal">
    <div class="modal-content">
        ...
        <p>Are you sure you want to save this medical clinic?</p>
