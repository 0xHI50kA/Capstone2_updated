        ...
        <div class="header">
			<div class="header-left">
				<a href="dashboard.php" class="logo">
					<img src="assets/img/logo.png" width="35" height="35" alt=""> <span>Atab HC</span>
				</a>
			</div>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li >
                            <a href="crud.php"><i class="fa fa-newspaper"></i><span>Announcement</span></a>
                        </li>
                        <li class="active">
                            <a href="crudServices.php"><i class="fa fa-tools"></i><span>Services</span></a>
                        </li>
                        <li>
                            <a href="crudLocator.php"><i class="fa fa-map-marker-alt"></i><span>Health Locator</span></a>
                        </li>
