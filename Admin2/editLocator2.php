...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE pharmacies SET name=?, image_path=?, map_embed=? WHERE id=?");
    $stmt->bind_param("sssi", $name, $imagePath, $mapEmbed, $id);

    if ($stmt->execute()) {
        echo "<script>
            setTimeout(function() {
                window.location.href = 'crudLocator2.php?updated=1';
            }, 1500);
        </script>";
    } else {
...
<div id="confirmModal">
    <div class="modal-content">
        ...
        <p>Are you sure you want to update this pharmacy?</p>
        <div>
