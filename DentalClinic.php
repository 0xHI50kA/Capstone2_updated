   ...
   <div class="our-team">
   	<div class="prof">
		<button class="back" onclick="window.location.href='nearby.html'">← Back</button>
   		<!-- <p class="pro text-center">Dental Clinic</p> -->
   		<p class="meet text-center">Find Dental Clinic Near You</p>
   	</div>
<div class="slide row">
    <?php
...
$sql = "SELECT * FROM nurse_profiles ORDER BY id DESC";
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $imagePath = 'Admin2/uploads2/' . $imageFilename;
        $link = '_dental' . $id . '.php';
...
<!-- <script type="text/javascript" src="javascript/DentalClinic.js"></script> -->
<script>
