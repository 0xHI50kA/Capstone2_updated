...
<!--=========== MY CSS LINK START =============-->
	...
	<link rel="stylesheet" type="text/css" href="css/index20.css">
...
<main>
   ...
   <div class="our-team">
   	<div class="prof">
		<button class="back" onclick="window.location.href='nearby.html'">← Back</button>
   		<!-- <p class="pro text-center">Medical</p> -->
   		<p class="meet text-center">Find Medical Clinic Near You</p>
   	</div>
...
// Fetch all nurse profiles from the database
$sql = "SELECT * FROM medical_clinics ORDER BY id DESC";
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $imageFilename = htmlspecialchars(basename($row['image_path']));
        $imagePath = 'Admin2/uploads3/' . $imageFilename;
        $link = '_medical' . $id . '.php';

        echo '
        <div class="teamlead animate col-sm-12 col-lg-4 col-md-6">
            <div class="nurse">
                <div class="doc-img">
    ...
    echo '<p>No nurse profiles found.</p>';
}
?>
	...
	<div class="footer-container">
		...
		<div class="footer-links">
			...
			<ul>
                ...
                <li ><a href="./Admin2/news-report.php">Announcement</a></li>
...
<!-- <script type="text/javascript" src="javascript/MedicalClinic.js"></script> -->
<script>
