   ...
   <div class="our-team">
   	<div class="prof">
		<button class="back"  onclick="window.location.href='nearby.html'">← Back</button>
   		...
   		<!-- <p class="pro text-center">PHARMACY</p> -->
   		<p class="meet text-center">List Of Pharmacies Near You</p>
   	</div>
...
$sql = "SELECT * FROM pharmacies ORDER BY id DESC";
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $imagePath = 'Admin2/uploads4/' . $imageFilename;
        $link = '_pharmacy' . $id . '.php';
...
<!-- <script type="text/javascript" src="javascript/pharmacies.js"></script> -->
<script>
