   ...
   <div class="our-team">
   	<div class="prof">
		<button class="back" onclick="window.location.href='nearby.html'">← Back</button>
   		...
   		<p class="meet text-center">Find Hospitals Near You</p>
   	</div>
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $imagePath = 'Admin2/uploads5/' . $imageFilename;
        $link = '_hospital' . $id . '.php';
...
<!-- <script type="text/javascript" src="javascript/Hospitals.js"></script> -->
<script>
